...
# Separar la columna location en Distrito y Cantón
library(tidyr)
cars <- cars %>% 
  separate(location, into = c("Provincia", "Canton"), sep = " - ")
View(cars)
colnames(cars) <- c("marca", "precio", "annio", "kilometros", "canton", "provincia", "currency")
