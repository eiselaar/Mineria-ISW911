...
# Primero, limpia los dispositivos gráficos existentes
if(length(dev.list()) > 0) {
  dev.off()
}

# Configura un nuevo dispositivo gráfico con dimensiones adecuadas
...
corrplot(matriz_corr_norm, 
         ...
         cl.ratio = 0.2)     # Ajusta la proporción de la leyenda de colores
